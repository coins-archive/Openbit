...
RESOURCES += src/qt/Openbit.qrc src/qt/Openbit_locale.qrc

TRANSLATIONS += src/qt/locale/Openbit_bg.ts \
                src/qt/locale/Openbit_de.ts \
                src/qt/locale/Openbit_en.ts \
                src/qt/locale/Openbit_es.ts \
                src/qt/locale/Openbit_fi.ts \
                src/qt/locale/Openbit_fr.ts \
                src/qt/locale/Openbit_it.ts \
                src/qt/locale/Openbit_ja.ts \
                src/qt/locale/Openbit_pl.ts \
                src/qt/locale/Openbit_pt.ts \
                src/qt/locale/Openbit_ru.ts \
                src/qt/locale/Openbit_sk.ts \
                src/qt/locale/Openbit_sv.ts \
                src/qt/locale/Openbit_vi.ts \
                src/qt/locale/Openbit_zh_CN.ts \
                src/qt/locale/Openbit_zh_TW.ts
