...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Openbit server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Openbit features */
        {"Openbit", "masternode", &masternode, true, true, false},
        {"Openbit", "listmasternodes", &listmasternodes, true, true, false},
        {"Openbit", "getmasternodecount", &getmasternodecount, true, true, false},
        {"Openbit", "masternodeconnect", &masternodeconnect, true, true, false},
        {"Openbit", "masternodecurrent", &masternodecurrent, true, true, false},
        {"Openbit", "masternodedebug", &masternodedebug, true, true, false},
        {"Openbit", "startmasternode", &startmasternode, true, true, false},
        {"Openbit", "createmasternodekey", &createmasternodekey, true, true, false},
        {"Openbit", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"Openbit", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"Openbit", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"Openbit", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"Openbit", "getmasternodescores", &getmasternodescores, true, true, false},
        {"Openbit", "mnbudget", &mnbudget, true, true, false},
        {"Openbit", "preparebudget", &preparebudget, true, true, false},
        {"Openbit", "submitbudget", &submitbudget, true, true, false},
        {"Openbit", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"Openbit", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Openbit", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"Openbit", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"Openbit", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Openbit", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"Openbit", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Openbit", "checkbudgets", &checkbudgets, true, true, false},
        {"Openbit", "mnsync", &mnsync, true, true, false},
        {"Openbit", "spork", &spork, true, true, false},
        {"Openbit", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"Openbit", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use Openbitd, or the -server option to Openbit-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> Openbit-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:7090/\n";
}
