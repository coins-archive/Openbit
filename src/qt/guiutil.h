...
/** Utility functions used by the Openbit Qt UI.
 */
namespace GUIUtil
{
...
// Render Openbit addresses in moOpenbitpace font
...
// Parse "Openbit:" URI into recipient object, return true on successful parsing
