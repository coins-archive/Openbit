                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Openbit Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Openbit address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Openbit: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zOPN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Openbit Core"), this);
    aboutAction->setStatusTip(tr("Show information about Openbit Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Openbit"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Openbit addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Openbit addresses"));
    ...
    openInfoAction->setStatusTip(tr("Show diagOpenbittic information"));
    ...
    openAction->setStatusTip(tr("Open a Openbit: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Openbit Core help message to get a list with possible Openbit command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Openbit Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Openbit network", "", count));
}
...
{
    QString strTitle = tr("Openbit Core"); // default title
...
/** Creates context menu, its actions, and Openbits up all the relevant signals for mouse events. */
