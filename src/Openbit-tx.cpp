...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Openbit Core Openbit-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  Openbit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Openbit transaction") + "\n" +
                               "  Openbit-tx [options] -create [commands]   " + _("Create hex-encoded Openbit transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Openbit transaction
