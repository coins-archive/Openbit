...
In order to support loading of multiple wallets in Openbit-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Openbit.cpp.
...
Changes to Openbit.cpp
----------------------
Openbit.cpp is the entry point into Openbit-qt, and as such, will require some minor modifications to provide hooks for
