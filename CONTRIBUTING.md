Contributing to Openbit Core
============================

The Openbit Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Openbit Core project, and is not to be
confused with overall Openbit Network Protocol consensus changes.

Whether a pull request is merged into Openbit Core rests with the project merge
...
Patches that change Openbit consensus rules are considerably more involved than
...
Where a patch set proposes to change the Openbit consensus, it must have been
...
The project leader is the release manager for each Openbit Core release.
